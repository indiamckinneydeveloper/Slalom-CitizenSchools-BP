...
var transporter = nodemailer.createTransport({
  service: 'Gmail',
  auth: {
    user: 'indiamckinneydeveloper@gmail.com',
    pass: 'ilovecode1'
  }
});
...
function sendMail(mailData){
  ...
  var mailOptions = {
    from: 'India ✔ <indiamckinneydeveloper@gmail.com>', // sender address
    to: 'indiamckinneydeveloper@gmail.com, bailey1.brandon@gmail.com ' + mailData.email, // list of receivers
